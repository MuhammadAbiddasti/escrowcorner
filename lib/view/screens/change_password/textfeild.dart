...
class CustomNewField extends StatefulWidget {
  final String? hint;
  final String? label;
  ...
  final _state = _CustomNewFieldState();

  @override
  _CustomNewFieldState createState() {
    return _state;
  }
...
class _CustomNewFieldState extends State<CustomNewField> {
  late bool _isHidden;
  String text = "";
  ...
  void initState() {
    ...
    _isHidden = isPasswordField; // Set _isHidden based on isPasswordField
    errorMessage = null;
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      padding: EdgeInsets.symmetric(horizontal: 5), // Add padding inside the container
      child: TextFormField(
        ...
        obscureText: _isHidden, // Use _isHidden for controlling password visibility
        onTap: widget.onTap,
        ...
        decoration: InputDecoration(
          labelStyle: TextStyle(color: Color(0xff666565)),
