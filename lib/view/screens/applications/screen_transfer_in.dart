...
class ScreenTransferIn extends StatefulWidget {
  final String merchantId;
  final String merchantName;

  ScreenTransferIn({required this.merchantId, required this.merchantName});

  @override
  _ScreenTransferInState createState() => _ScreenTransferInState();
}
...
class _ScreenTransferInState extends State<ScreenTransferIn> {
  ...
  void _handleTransferIn() async {
    ...
    try {
      // Call the controller method to submit deposit request
      final result = await controller.submitDepositRequest(
        widget.merchantId,
