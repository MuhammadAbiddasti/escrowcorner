...
import 'package:dacotech/view/screens/escrow_system/request_escrow/request_escrow_detail.dart';
...
import '../send_escrow/screen_create_escrow.dart';
import 'new_request_escrow.dart';
...
class _GetRequestEscrowState extends State<GetRequestEscrow> {
          ...
          child: ListView(
            children:[
              ...
              children: [
                ...
                // ).paddingOnly(top: 20),
                if (isManager &&
                    allowedModules.containsKey('Request Escrow') &&
                    allowedModules['Request Escrow']!.contains('add_request_escrow'))
                  Container(
                    width: MediaQuery.of(context).size.width * 0.9,
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(10),
