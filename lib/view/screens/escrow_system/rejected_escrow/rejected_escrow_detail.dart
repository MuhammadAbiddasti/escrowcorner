...
class RejectedEscrowDetailScreen extends StatefulWidget {
  final int escrowId;

  RejectedEscrowDetailScreen({required this.escrowId});

  @override
  _RejectedEscrowDetailScreenState createState() => _RejectedEscrowDetailScreenState();
}

class _RejectedEscrowDetailScreenState extends State<RejectedEscrowDetailScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CommonHeader(
        title: languageController.getTranslation('rejected_escrow_detail'),
                          ...
                          children: [
                            Obx(() {
                              if (controller.escrowAgreementDetail.isNotEmpty) {
                                ...
                                return Text(
                                  agreementDetails.title ?? languageController.getTranslation('rejected_escrow_detail'),
                                  style: TextStyle(
                                ...
                                return Text(
                                  languageController.getTranslation('rejected_escrow_detail'),
                                  style: TextStyle(
                                    fontWeight: FontWeight.w700,
                                    fontSize: 16,
                                    color: Color(0xff18CE0F),
                                  ...
                                  child: Center(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(height: 8),
                                        Text(
                                          'API Endpoint: /api/rejected_escrow/${widget.escrowId}',
