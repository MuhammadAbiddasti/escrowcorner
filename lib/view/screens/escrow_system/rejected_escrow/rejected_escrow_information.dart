...
class RejectedEscrowInformationScreen extends StatefulWidget {
  final int escrowId;

  RejectedEscrowInformationScreen({required this.escrowId});

  @override
  _RejectedEscrowInformationScreenState createState() => _RejectedEscrowInformationScreenState();
}

class _RejectedEscrowInformationScreenState extends State<RejectedEscrowInformationScreen> {
